...
-- Agregar columnas que falten (ejecutar siempre - no da error si ya existen)
...
-- PASO 2: Crear tabla subjects (eliminar si existe)
-- =====================================================
...
-- Eliminar políticas existentes (sin errores si no existen)
...
-- PASO 8: Crear función y triggers
-- =====================================================
...
-- Eliminar triggers existentes (sin errores)
...
-- PASO 9: Insertar usuario admin de ejemplo
-- =====================================================
...
SELECT 
    ...
    NOW()
WHERE NOT EXISTS (
    SELECT 1 FROM users WHERE email = 'admin@ipdvs.edu.ar'
);
...
SELECT 
    CASE 
        ...
        THEN 'Usuario administrador creado correctamente'
        ELSE 'No se pudo crear el usuario administrador'
    END as admin_status;
