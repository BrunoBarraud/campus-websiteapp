  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed inset-y-0 left-0 z-40 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out">
        <div className="flex items-center justify-center h-16 px-4 bg-gradient-to-r from-yellow-400 to-yellow-500">
          <Link href="/campus/dashboard" className="flex items-center">
            <h1 className="text-xl font-bold text-white hover:text-gray-100 transition-colors">Campus IPDVS</h1>
          </Link>
        </div>
