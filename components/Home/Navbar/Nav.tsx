      ...
      <div className="flex items-center h-full justify-between w-[95%] sm:w-[90%] xl:w-[80%] mx-auto px-2 sm:px-0">
        ...
        <div className="flex items-center space-x-1 sm:space-x-2">
          ...
          <div className="flex items-center space-x-0.5 sm:space-x-1">
            <span
              className="text-sm sm:text-lg md:text-xl lg:text-2xl text-rose-950 uppercase font-bold bg-amber-400 px-1 sm:px-2 py-0.5 rounded-lg shadow-lg"
            >
              Campus
            </span>
            <span
              className="text-sm sm:text-lg md:text-xl lg:text-2xl text-amber-400 uppercase font-bold bg-rose-950 px-1 sm:px-2 py-0.5 rounded-lg shadow-lg"
            >
              Virtual
            </span>
          </div>
