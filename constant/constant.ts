...
export const CAMPUS_NAVIGATION = {
  ...
  admin: [
    ...
    {
      id: 8,
      url: "/campus/admin/users",
      label: "Gestión de Usuarios",
      icon: "👥",
    },
    {
      id: 9,
      url: "/campus/admin/subjects",
  ...
  teacher: [
    {
      id: 10,
      url: "/campus/teacher/subjects",
      label: "Mis Materias",
      icon: "📝",
    },
    {
      id: 11,
      url: "/campus/teacher/grades",
  ...
  student: [
    {
      id: 12,
      url: "/campus/student/subjects",
      label: "Mis Cursos",
      icon: "🎓",
    },
    {
      id: 13,
      url: "/campus/student/grades",
...
export const APP_CONFIG = {
  ...
  version: "1.0.0",
  description:
    "Plataforma educativa del Instituto Privado Domingo Victorio Sarmiento",
  defaultTheme: "light",
