...
export const AcademicUtils = {
  ...
  getRoleName: (role: string): string => {
    return (
      ACADEMIC_CONFIG.ROLE_NAMES[
        role as keyof typeof ACADEMIC_CONFIG.ROLE_NAMES
      ] || role
    );
  },
};
...
export type Role =
  (typeof ACADEMIC_CONFIG.ROLES)[keyof typeof ACADEMIC_CONFIG.ROLES];
export type NotificationType =
  (typeof ACADEMIC_CONFIG.NOTIFICATIONS.TYPES)[keyof typeof ACADEMIC_CONFIG.NOTIFICATIONS.TYPES];
export type ConversationType =
  (typeof ACADEMIC_CONFIG.CONVERSATIONS.TYPES)[keyof typeof ACADEMIC_CONFIG.CONVERSATIONS.TYPES];
