...
export async function GET() {
  try {
    ...
    if (!settings) {
      ...
      if (createError) {
        console.error(
          "Error creating default notification settings:",
          createError
        );
        return NextResponse.json(
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (assignment_notifications !== undefined)
      updateData.assignment_notifications = assignment_notifications;
    if (grade_notifications !== undefined)
      updateData.grade_notifications = grade_notifications;
    ...
    if (announcement_notifications !== undefined)
      updateData.announcement_notifications = announcement_notifications;
    if (system_notifications !== undefined)
      updateData.system_notifications = system_notifications;
