...
export default function TeacherAssignmentsPage({
  ...
  const handleDelete = async (assignmentId: string) => {
    ...
    const submissionsText = assignment?.submissions_count
      ? `\n\nEsta acción también eliminará ${assignment.submissions_count} entrega(s) de estudiantes.`
      : "";

    if (
      !confirm(
        `¿Estás seguro de que quieres eliminar la tarea "${assignment?.title}"?${submissionsText}\n\nEsta acción no se puede deshacer.`
      )
    )
      return;
