      ...
      <CampusLayout>
        <div className="p-6">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
            <h1 className="text-2xl font-bold text-yellow-800 mb-2">No hay sesión</h1>
        ...
        <div className="p-6">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            ...
            <div className="mt-4 p-4 bg-gray-100 rounded text-left">
              ...
              <p className="text-sm">Rol detectado: {session?.user?.role || 'undefined'}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/campus/settings/users" className="group">
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-blue-500">
              ...
              <p className="text-gray-600">Administra estudiantes, profesores y otros usuarios del sistema</p>
              <div className="mt-4">
                <span className="text-sm text-blue-600 font-medium">Administrar usuarios →</span>
              </div>
            </div>
          </Link>
          ...
          <Link href="/campus/settings/subjects" className="group">
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-green-500">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Gestión de Materias</h3>
              <p className="text-gray-600">Crea, edita y organiza las materias del campus</p>
              <div className="mt-4">
                <span className="text-sm text-green-600 font-medium">Administrar materias →</span>
              </div>
            </div>
          </Link>
          ...
          <Link href="/campus/settings/general" className="group">
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-purple-500">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Configuración General</h3>
              <p className="text-gray-600">Ajustes generales del sistema y preferencias</p>
              <div className="mt-4">
                <span className="text-sm text-purple-600 font-medium">Ver configuración →</span>
              </div>
            </div>
          </Link>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600">Genera reportes del sistema y actividad de usuarios</p>
            <div className="mt-4">
              <button className="text-sm text-red-600 font-medium">Generar reporte →</button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Respaldos</h3>
            <p className="text-gray-600">Gestiona respaldos y restauración de datos</p>
            <div className="mt-4">
              <button className="text-sm text-indigo-600 font-medium">Crear respaldo →</button>
            </div>
          </div>
